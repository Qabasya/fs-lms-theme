 ...
 * Inc\Core\Assets\BundleLoader::enqueueUiFont()) плюс вес 300 и JetBrains
 * Mono, которые требует дизайн главной страницы (мокап «Главная — 1a»:
 * лид-абзацы весом 300, блок кода моноширинным).
 */
