	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:360px">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-text-secondary-color has-white-background-color has-text-color has-background wp-element-button" href="#lessons">О занятиях</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group fs-features-grid">
				<!-- wp:fs-lms/feature-card {"icon":"users","iconColor":"accent","iconBackground":"accent-soft","title":"Группы до 8 человек","text":"Занятия в приятной атмосфере в центре Калининграда. Можно заниматься вместе со своими друзьями или найти единомышленников на занятиях"} -->
				...
				<!-- wp:fs-lms/feature-card {"icon":"record","iconColor":"accent","iconBackground":"accent-soft","title":"Запись каждого занятия","text":"Пришлось пропустить занятие? Не переживай, его можно посмотреть в записи и прорешать весь пройденный материал самостоятельно с поддержкой преподавателя"} -->
				<div class="wp-block-fs-lms-feature-card fs-feature-card"><span class="fs-feature-card__icon has-accent-color has-accent-soft-background-color has-text-color has-background"><svg width="19" height="19" viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M2.5 6h10v8h-10z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"></path><path d="M12.5 9.2 17 6.5v7l-4.5-2.7z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"></path></svg></span><h3 class="fs-feature-card__title">Запись каждого занятия</h3><p class="fs-feature-card__text">Пришлось пропустить занятие? Не переживай, его можно посмотреть в записи и прорешать весь пройденный материал самостоятельно с поддержкой преподавателя</p></div>
				<!-- /wp:fs-lms/feature-card -->

				<!-- wp:fs-lms/feature-card {"icon":"document","iconColor":"accent","iconBackground":"accent-soft","title":"Свой учебник и материалы","text":"Ученикам доступны конспекты, шпаргалки и памятки по каждой теме — можно закрепить знания и вспомнить всё необходимое перед контрольной или экзаменом"} -->
				<div class="wp-block-fs-lms-feature-card fs-feature-card"><span class="fs-feature-card__icon has-accent-color has-accent-soft-background-color has-text-color has-background"><svg width="19" height="19" viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M5 2.5h6.2L15.5 6.8V17.5H5V2.5z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"></path><path d="M11 3v4.3h4.3" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"></path></svg></span><h3 class="fs-feature-card__title">Свой учебник и материалы</h3><p class="fs-feature-card__text">Ученикам доступны конспекты, шпаргалки и памятки по каждой теме — можно закрепить знания и вспомнить всё необходимое перед контрольной или экзаменом</p></div>
				<!-- /wp:fs-lms/feature-card -->

				<!-- wp:fs-lms/feature-card {"icon":"spark","iconColor":"accent","iconBackground":"accent-soft","title":"Проекты и практика","text":"На каждом направлении есть свои соревнования, пробники и проекты с разбором решений, а также система мотивации и контроля домашних работ"} -->
				<div class="wp-block-fs-lms-feature-card fs-feature-card"><span class="fs-feature-card__icon has-accent-color has-accent-soft-background-color has-text-color has-background"><svg width="19" height="19" viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M10 3 12 7l4.5.6-3.3 3.2.8 4.5L10 13.2 6 15.5l.8-4.5L3.5 7.7 8 7z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"></path></svg></span><h3 class="fs-feature-card__title">Проекты и практика</h3><p class="fs-feature-card__text">На каждом направлении есть свои соревнования, пробники и проекты с разбором решений, а также система мотивации и контроля домашних работ</p></div>
				<!-- /wp:fs-lms/feature-card -->
			</div>
			<!-- /wp:group -->
		</div>
