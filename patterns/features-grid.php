...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--xxl);padding-bottom:var(--wp--preset--spacing--xxxl);padding-left:var(--wp--preset--spacing--xxl)">
	<!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|xxxl"}}}} -->
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:340px">
			...
			<p class="has-text-secondary-color has-text-color has-sm-font-size">» Тебе не хватает мотивации заниматься самостоятельно?</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"textColor":"text-secondary","fontSize":"sm"} -->
			<p class="has-text-secondary-color has-text-color has-sm-font-size">» Сомневаешься, что школьный учитель эффективно подготовит тебя к ЕГЭ?</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"textColor":"text-secondary","fontSize":"sm"} -->
			<p class="has-text-secondary-color has-text-color has-sm-font-size">» Хочешь поступить в вуз твоей мечты и переехать в крупный город?</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"fontSize":"sm"} -->
			<p class="has-sm-font-size">Как нам это знакомо. Присоединяйся, вместе мы со всем справимся!</p>
			<!-- /wp:paragraph -->
