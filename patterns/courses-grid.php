 ...
 * единого `accent-2`: Робототехника=`violet`, Python=`ok`,
 * ОГЭ=`subject-yellow-text` (новый вариант в `BADGE_COLORS`/`colors.js`,
 * пара с подложкой `subject-yellow` через `BG_OVERRIDE`), ЕГЭ=`info`.
 *
...
<div id="dirs" class="wp-block-group" style="padding-top:0;padding-bottom:5.5rem">
	...
	<div class="wp-block-group fs-courses-grid">
		...
		<!-- wp:fs-lms/course-card {"imageUrl":"<?php echo esc_url( get_theme_file_uri( 'img/dir-oge.png' ) ); ?>","imageAlt":"ОГЭ по информатике","badgeText":"9 класс","badgeColor":"subject-yellow-text","title":"ОГЭ по информатике","caption":"Полный разбор формата экзамена, регулярные пробники и работа над ошибками.","price":"6 400 ₽","priceUnit":"/ мес","buttonText":"Подробнее","buttonUrl":"<?php echo fs_lms_theme_subject_url( 'inf_oge', 'overview' ); ?>"} -->
		<div class="wp-block-fs-lms-course-card fs-course-card"><div class="fs-course-card__media"><img src="<?php echo esc_url( get_theme_file_uri( 'img/dir-oge.png' ) ); ?>" alt="ОГЭ по информатике" /></div><div class="fs-course-card__body"><span class="fs-course-card__badge has-subject-yellow-text-color has-subject-yellow-background-color has-text-color has-background">9 класс</span><h3 class="fs-course-card__title">ОГЭ по информатике</h3><p class="fs-course-card__caption">Полный разбор формата экзамена, регулярные пробники и работа над ошибками.</p><div class="fs-course-card__footer"><div class="fs-course-card__price"><span class="fs-course-card__price-amount">6 400 ₽</span><span class="fs-course-card__price-unit">/ мес</span></div><a class="fs-course-card__button wp-element-button" href="<?php echo fs_lms_theme_subject_url( 'inf_oge', 'overview' ); ?>">Подробнее</a></div></div></div>
		<!-- /wp:fs-lms/course-card -->
		...
		<div class="wp-block-fs-lms-course-card fs-course-card"><div class="fs-course-card__media"><img src="<?php echo esc_url( get_theme_file_uri( 'img/dir-ege.png' ) ); ?>" alt="ЕГЭ по информатике" /></div><div class="fs-course-card__body"><span class="fs-course-card__badge has-info-color has-info-soft-background-color has-text-color has-background">11 класс</span><h3 class="fs-course-card__title">ЕГЭ по информатике</h3><p class="fs-course-card__caption">Все задания экзамена, программирование на Python и индивидуальные консультации с репетитором.</p><div class="fs-course-card__footer"><div class="fs-course-card__price"><span class="fs-course-card__price-amount">6 400 ₽</span><span class="fs-course-card__price-unit">/ мес</span></div><a class="fs-course-card__button wp-element-button" href="<?php echo fs_lms_theme_subject_url( 'inf_ege', 'overview' ); ?>">Подробнее</a></div></div></div>
		<!-- /wp:fs-lms/course-card -->
