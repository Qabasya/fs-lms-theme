...
<div class="wp-block-group fs-section">
	...
	<div class="wp-block-columns fs-hero-columns">
		...
		<div class="wp-block-column">
			<!-- wp:group {"className":"fs-subject-hero-box fs-subject-hero-box--robo","layout":{"type":"constrained"}} -->
			<div class="wp-block-group fs-subject-hero-box fs-subject-hero-box--robo">
