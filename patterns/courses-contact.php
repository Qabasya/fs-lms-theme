		...
		<div class="wp-block-column" style="flex-basis:480px">
			...
			<form class="fs-apply-form" id="courses-apply-form" data-fs-form>
				...
				<div class="fs-form-field">
					...
					<input type="text" id="fs-courses-apply-name" name="parent_name" placeholder="Иванова Анна Ивановна" autocomplete="name" pattern="[А-Яа-яЁё\s\-]{2,80}" minlength="2" maxlength="80" title="Только буквы кириллицы, пробелы и дефис" required>
				</div>
