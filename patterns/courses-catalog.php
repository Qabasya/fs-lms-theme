...
<div class="wp-block-group fs-section">
	...
	<!-- wp:fs-lms/catalog-card {"imageUrl":"<?php echo esc_url( get_theme_file_uri( 'img/courses-py.png' ) ); ?>","imageAlt":"Разработка на Python","badgeColor":"ok","buttonText":"Подробнее","buttonUrl":"<?php echo esc_url( fs_lms_theme_subject_url( 'python', 'overview' ) ); ?>","grade":"10"} -->
