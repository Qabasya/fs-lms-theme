...
<div class="wp-block-group has-white-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--xxxl);padding-bottom:0;background-color:#2b2f36">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group fs-footer-grid">
			...
			<!-- wp:group {"className":"fs-footer-grid__map"} -->
			<div class="wp-block-group fs-footer-grid__map">
				<!-- wp:html -->
			...
			<!-- wp:group {"className":"fs-footer-grid__col"} -->
			<div class="wp-block-group fs-footer-grid__col">
				<!-- wp:paragraph {"className":"fs-footer-grid__title"} -->
				<p class="fs-footer-grid__title">Информация</p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"className":"fs-footer-grid__lead"} -->
				<p class="fs-footer-grid__lead">ИП Иванов Борис Олегович<br>ИНН: 390407910400<br>ОГРН: 322390000000350</p>
				<!-- /wp:paragraph -->
		...
		<!-- wp:paragraph {"className":"fs-footer-bottom"} -->
		<p class="fs-footer-bottom">© <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?>. Репетитор ЕГЭ по информатике. Россия, Калининград.</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
